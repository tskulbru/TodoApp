...
public class TaskListFragment extends ListFragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if(mDbHelper.count() < 1)
			insertRow();
		
		Cursor mCursor = mDbHelper.getAllTodoItems();
		
		setListAdapter(new SimpleCursorAdapter(
				getActivity(),
				android.R.layout.simple_list_item_activated_1,
				mCursor, 
				new String[] { TodoContract.TodoItem.COLUMN_NAME_TITLE }, // The column we want to extract data from and show in the list 
				new int[] { android.R.id.text1 }, // The layout element to write the value to
				0));
	}
	...
	private long insertRow() {
		...
		values.put(TodoContract.TodoItem.COLUMN_NAME_TODO_ID, "1");
		values.put(TodoContract.TodoItem.COLUMN_NAME_TITLE, "Do stuff");
		values.put(TodoContract.TodoItem.COLUMN_NAME_DESC, "Must do plenty of stuff");
